...
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("BY BLOODIE"), oxorany("https://chat.whatsapp.com/BEspMtKkGOsBWM5y36ZhqI"));
ImGui::TextDisabled(oxorany("CHANNEL:"));
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("MI GRUPO"), oxorany("https://chat.whatsapp.com/BEspMtKkGOsBWM5y36ZhqI"));
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("MI GRUPO"), oxorany("https://chat.whatsapp.com/BEspMtKkGOsBWM5y36ZhqI"));
ImGui::Spacing();
ImGui::EndTabItem();
...
get_transform = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x84511D4")); 
  
get_transformFF = (void *(*)(void *)) getRealOffset(ENCRYPTOFFSET("0x104ADACD4"));

get_position = (Vector3 (*)(void*)) getRealOffset(ENCRYPTOFFSET("0x8260E8C"));

get_camera = (void *(*)()) getRealOffset(ENCRYPTOFFSET("0x844E7BC"));

worldToScreen = (Vector3 (*)(void *, Vector3)) getRealOffset(ENCRYPTOFFSET("0x844DE48"));

WorldToViewpoint = (Vector3 (*)(void *, Vector3, int ))getRealOffset(ENCRYPTOFFSET("0x844DE48"));
