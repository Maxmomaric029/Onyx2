...
static void *CurentMatch() {
    void *(*_CurentMatch) (void *instance) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x1A93774")); 
    return _CurentMatch(NULL);
}

static Vector3 Transform_GetPosition(void *player) {
    Vector3 out = Vector3::zero();
    void (*_Transform_GetPosition)(void *transform, Vector3 * out) = (void (*)(void *, Vector3 *))getRealOffset(ENCRYPTOFFSET("0x8260E8C"));
...
static Vector3 Transform_INTERNAL_GetPosition(void *player) {
    Vector3 out = Vector3::zero();
    void (*_Transform_INTERNAL_GetPosition)(void *transform, Vector3 * out) = (void (*)(void *, Vector3 *))getRealOffset(ENCRYPTOFFSET("0x8260E8C"));
...
static void *GetLocalPlayer(void* Match) {
    ...
    return *(void**)((uintptr_t)Match + 0x44);
}

static void *Current_Local_Player() {
    void *(*_Local_Player)(void *players) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x1A93D74"));
...
Vector3 GetHeadPosition(void* player) {
    void *HeadITF= *(void **)((uintptr_t) player + 0x3F8);
...
static void *Camera_main() {
    void *(*_Camera_main)(void *nuls) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x844E7BC"));
...
Vector3 GetToePosition(void* player) {
    void *ToeITF= *(void **)((uintptr_t) player + 0x40C); //ITransformNode AGHJLIMNPJA
...
static bool get_isVisible(void *player) {
    bool (*_get_isVisible)(void *players) = (bool (*)(void *))getRealOffset(ENCRYPTOFFSET("0x15035F8"));
    return _get_isVisible(player);
}

static void *Component_GetTransform(void *player) {
    void *(*_Component_GetTransform)(void *component) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x84511D4"));  //   public Transform get_transform() { }
...
static bool get_isLocalTeam(void *player) {
    bool (*_get_isLocalTeam)(void *players) = (bool (*)(void *))getRealOffset(ENCRYPTOFFSET("0x151F070")); 
    return _get_isLocalTeam(player);
}

static bool get_IsDieing(void *player) {
    bool (*_get_die)(void *players) = (bool (*)(void *))getRealOffset(ENCRYPTOFFSET("0x14E7C88")); 
    return _get_die(player);
}

static int GetHp(void* player) {
    int (*_GetHp)(void* players) = (int(*)(void *))getRealOffset(ENCRYPTOFFSET("0x15811A0")); 
...
static bool get_IsSighting(void *player) {
    bool (*_get_Isighting)(void *players) = (bool (*)(void *))getRealOffset(ENCRYPTOFFSET("0x14F0CE0")); 
...
static bool get_IsFiring(void *player) {
    bool (*_get_IsFiring)(void *players) = (bool (*)(void *))getRealOffset(ENCRYPTOFFSET("0x14EADAC")); 
    return _get_IsFiring(player);
}

static Vector3 GetForward(void *player) {
    Vector3 (*_GetForward)(void *players) = (Vector3 (*)(void *))getRealOffset(ENCRYPTOFFSET("0x82619EC")); 
    return _GetForward(player);
}

static void set_aim(void *player, Quaternion look) {
    void (*_set_aim_nepmods)(void *players, Quaternion lock) = (void (*)(void *, Quaternion))getRealOffset(ENCRYPTOFFSET("0x14FB674")); 
...
void DrawEsp() {
    ...
    if (ESPEnable) {
        ...
        if (local_player != nullptr && current_Match != nullptr) {
            Dictionary<uint8_t *, void **> *players = *(Dictionary<uint8_t*, void **> **)((long)current_Match + 0x68);
